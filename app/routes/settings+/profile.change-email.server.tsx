...
export async function handleVerification({
	...
	void sendEmail({
		...
		subject: 'DinnerNotOnYourOwn email changed',
...
export function EmailChangeEmail({
	...
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>DinnerNotOnYourOwn Email Change</E.Text>
				</h1>
				<p>
					<E.Text>
...
function EmailChangeNoticeEmail({ userId }: { userId: string }) {
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Your DinnerNotOnYourOwn email has been changed</E.Text>
				</h1>
				<p>
					<E.Text>
						We're writing to let you know that your DinnerNotOnYourOwn email has been
						changed.
					</E.Text>
				</p>
				<p>
